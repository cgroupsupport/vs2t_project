...
.UARTRX_ReadRx:
   ...
   tst  REG[UART_1_RX_BUFFER_REG], 0x00                    ; Read the data buffer to clear it.
...
.UARTRX_CHK_OVFL:                                          ; Check for MAX String here
   ...
   RAM_SETPAGE_IDX >UART_1_aRxBuffer                       ;   using idexed address mode
   cmp  [UART_1_bRxCnt],(UART_1_RX_BUFFER_SIZE - 1)
   jc   .UARTRX_ISR_GETDATA
   RAM_CHANGE_PAGE_MODE FLAG_PGMODE_10b
   mov  [X + UART_1_aRxBuffer],00h                         ; Zero out last data in the buffer
   RAM_CHANGE_PAGE_MODE FLAG_PGMODE_00b
