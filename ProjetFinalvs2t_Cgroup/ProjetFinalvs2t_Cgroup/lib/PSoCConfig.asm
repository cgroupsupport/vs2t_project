...
export LoadConfig_ProjetComplet
export _LoadConfig_ProjetComplet
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_ProjetComplet
	lcall	LoadConfigTBL_ProjetComplet_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration ProjetComplet
;
;    Load configuration registers for ProjetComplet.
...
;               CUR_PP
;
_LoadConfig_ProjetComplet:
 LoadConfig_ProjetComplet:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_ProjetComplet_Bank0
    mov     X, <LoadConfigTBL_ProjetComplet_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_ProjetComplet_Bank1
    mov     X, <LoadConfigTBL_ProjetComplet_Bank1
