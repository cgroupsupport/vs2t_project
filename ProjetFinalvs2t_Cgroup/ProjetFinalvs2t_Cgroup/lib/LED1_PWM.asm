...
include "m8c.inc"
include "LED1_PWM.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  LED1_PWM_EnableInt
export _LED1_PWM_EnableInt
export  LED1_PWM_DisableInt
export _LED1_PWM_DisableInt
export  LED1_PWM_Start
export _LED1_PWM_Start
export  LED1_PWM_Stop
export _LED1_PWM_Stop
export  LED1_PWM_WritePeriod
export _LED1_PWM_WritePeriod
export  LED1_PWM_WritePulseWidth
export _LED1_PWM_WritePulseWidth
export  LED1_PWM_wReadPulseWidth
export _LED1_PWM_wReadPulseWidth
export  LED1_PWM_wReadCounter
export _LED1_PWM_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wLED1_PWM_ReadPulseWidth    ; deprecated
export _wLED1_PWM_ReadPulseWidth    ; deprecated
export  wLED1_PWM_ReadCounter       ; deprecated
export _wLED1_PWM_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED1_PWM_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED1_PWM_DisableInt
;
;  DESCRIPTION:
...
;
 LED1_PWM_DisableInt:
_LED1_PWM_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   LED1_PWM_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED1_PWM_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 LED1_PWM_WritePeriod:
_LED1_PWM_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[LED1_PWM_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[LED1_PWM_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED1_PWM_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 LED1_PWM_WritePulseWidth:
_LED1_PWM_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[LED1_PWM_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[LED1_PWM_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED1_PWM_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 LED1_PWM_wReadPulseWidth:
_LED1_PWM_wReadPulseWidth:
 wLED1_PWM_ReadPulseWidth:                       ; this name deprecated
_wLED1_PWM_ReadPulseWidth:                       ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[LED1_PWM_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[LED1_PWM_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED1_PWM_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 LED1_PWM_wReadCounter:
_LED1_PWM_wReadCounter:
 wLED1_PWM_ReadCounter:                          ; this name deprecated
_wLED1_PWM_ReadCounter:                          ; this name deprecated
   ...
   mov   A, reg[LED1_PWM_COMPARE_MSB_REG]        ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[LED1_PWM_COMPARE_LSB_REG]        ;
   push  A                                          ;  -stack frame now 2 bytes-
   LED1_PWM_Stop_M                               ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[LED1_PWM_INPUT_LSB_REG]          ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[LED1_PWM_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[LED1_PWM_COUNTER_MSB_REG]        ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[LED1_PWM_COMPARE_MSB_REG]        ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[LED1_PWM_COUNTER_LSB_REG]        ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[LED1_PWM_COMPARE_LSB_REG]        ; Stash the Count LSB on the stack
   ...
   mov   reg[LED1_PWM_INPUT_LSB_REG], A          ;    and restore it
   M8C_SetBank0                                     ;
   LED1_PWM_Start_M                              ; Now re-enable the PWM function
