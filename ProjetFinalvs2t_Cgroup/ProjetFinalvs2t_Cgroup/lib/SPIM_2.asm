...
;  Global Symbols
;-----------------------------------------------
export   SPIM_2_EnableInt
export  _SPIM_2_EnableInt
export   SPIM_2_DisableInt
export  _SPIM_2_DisableInt
export   SPIM_2_Start
export  _SPIM_2_Start
export   SPIM_2_Stop
export  _SPIM_2_Stop
export   SPIM_2_SendTxData
export  _SPIM_2_SendTxData
export   SPIM_2_bReadRxData
export  _SPIM_2_bReadRxData
export   SPIM_2_bReadStatus
export  _SPIM_2_bReadStatus

// These globals will be removed in a future release
// Do not use
export   bSPIM_2_ReadRxData
export  _bSPIM_2_ReadRxData
export   bSPIM_2_ReadStatus
export  _bSPIM_2_ReadStatus
...
_SPIM_2_EnableInt:
   ...
   M8C_EnableIntMask SPIM_2_INT_REG, SPIM_2_bINT_MASK
...
_SPIM_2_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask SPIM_2_INT_REG, SPIM_2_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;     using the SPIM_2_SendTxData function.
;
;-----------------------------------------------------------------------------
;
;  ARGUMENTS:
...
_SPIM_2_Stop:
   ...
   and   REG[SPIM_2_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: SPIM_2_SendTxData
;
;  DESCRIPTION:
...
_SPIM_2_SendTxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   ; Transmit the data!
   mov REG[SPIM_2_TX_BUFFER_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: SPIM_2_bReadRxData
;
;  DESCRIPTION:
...
_bSPIM_2_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[SPIM_2_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1   
   ret
...
_bSPIM_2_ReadStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[SPIM_2_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1   
   ret

.ENDSECTION

; End of File SPIM_2.asm
