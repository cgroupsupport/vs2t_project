...
include "m8c.inc"
include "LED2_PWM.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  LED2_PWM_EnableInt
export _LED2_PWM_EnableInt
export  LED2_PWM_DisableInt
export _LED2_PWM_DisableInt
export  LED2_PWM_Start
export _LED2_PWM_Start
export  LED2_PWM_Stop
export _LED2_PWM_Stop
export  LED2_PWM_WritePeriod
export _LED2_PWM_WritePeriod
export  LED2_PWM_WritePulseWidth
export _LED2_PWM_WritePulseWidth
export  LED2_PWM_wReadPulseWidth
export _LED2_PWM_wReadPulseWidth
export  LED2_PWM_wReadCounter
export _LED2_PWM_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wLED2_PWM_ReadPulseWidth    ; deprecated
export _wLED2_PWM_ReadPulseWidth    ; deprecated
export  wLED2_PWM_ReadCounter       ; deprecated
export _wLED2_PWM_ReadCounter       ; deprecated


AREA ProjetComplet_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_PWM_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_PWM_DisableInt
;
;  DESCRIPTION:
...
;
 LED2_PWM_DisableInt:
_LED2_PWM_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   LED2_PWM_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_PWM_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 LED2_PWM_WritePeriod:
_LED2_PWM_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[LED2_PWM_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[LED2_PWM_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_PWM_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 LED2_PWM_WritePulseWidth:
_LED2_PWM_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[LED2_PWM_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[LED2_PWM_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_PWM_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 LED2_PWM_wReadPulseWidth:
_LED2_PWM_wReadPulseWidth:
 wLED2_PWM_ReadPulseWidth:                       ; this name deprecated
_wLED2_PWM_ReadPulseWidth:                       ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[LED2_PWM_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[LED2_PWM_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED2_PWM_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 LED2_PWM_wReadCounter:
_LED2_PWM_wReadCounter:
 wLED2_PWM_ReadCounter:                          ; this name deprecated
_wLED2_PWM_ReadCounter:                          ; this name deprecated
   ...
   mov   A, reg[LED2_PWM_COMPARE_MSB_REG]        ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[LED2_PWM_COMPARE_LSB_REG]        ;
   push  A                                          ;  -stack frame now 2 bytes-
   LED2_PWM_Stop_M                               ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[LED2_PWM_INPUT_LSB_REG]          ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[LED2_PWM_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[LED2_PWM_COUNTER_MSB_REG]        ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[LED2_PWM_COMPARE_MSB_REG]        ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[LED2_PWM_COUNTER_LSB_REG]        ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[LED2_PWM_COMPARE_LSB_REG]        ; Stash the Count LSB on the stack
   ...
   mov   reg[LED2_PWM_INPUT_LSB_REG], A          ;    and restore it
   M8C_SetBank0                                     ;
   LED2_PWM_Start_M                              ; Now re-enable the PWM function
